...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "Arial", padding: 20, background: "#f5f5f5" }}>
      ...
      <section style={{ padding: 20, background: "white", borderRadius: 8, marginBottom: 20 }}>
        <h2>➕ Create Item</h2>
        <input placeholder="Item name" style={{ width: "100%", padding: 8, marginBottom: 10 }}
          value={name} onChange={e => setName(e.target.value)} />

        <input placeholder="Description" style={{ width: "100%", padding: 8, marginBottom: 10 }}
        ...
        <pre style={{ background: "#f9f9f9", padding: 10, marginTop: 10 }}>
      ...
      <section style={{ padding: 20, background: "white", borderRadius: 8, marginBottom: 20 }}>
        ...
        <input placeholder="Item ID" style={{ padding: 8, marginRight: 10 }}
          value={getId} onChange={e => setGetId(e.target.value)} />

        <button onClick={getItem}
          style={{ padding: 10, background: "#2196F3", color: "white", border: "none", borderRadius: 4 }}>
          Get Item
        </button>
